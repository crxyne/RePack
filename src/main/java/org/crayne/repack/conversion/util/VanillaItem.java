...
public enum VanillaItem {
    ...
    public boolean armor() {
        return switch (this) {
            case turtle_helmet, golden_helmet, iron_helmet, diamond_helmet, chainmail_helmet, netherite_helmet, leather_helmet,
                    golden_chestplate, iron_chestplate, diamond_chestplate, chainmail_chestplate, netherite_chestplate, leather_chestplate,
                    golden_leggings, iron_leggings, diamond_leggings, chainmail_leggings, netherite_leggings, leather_leggings,
                    golden_boots, iron_boots, diamond_boots, chainmail_boots, netherite_boots, leather_boots -> true;
            default -> false;
        };
    }
